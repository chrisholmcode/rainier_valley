...
- donor_org: capture the printed **donor / source code** on the manifest verbatim (e.g., "SWY-GEN", "QFC-MI"). These short hyphenated codes identify the donating retailer/organization. Only set `donor_org = null` if no such donor code appears on the document.
