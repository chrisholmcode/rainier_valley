...
- invoice_or_order_number: Use the **Agency Order No** value in the upper-right (e.g., "ACR-XXXXXX"). If no "ACR-" Agency Order No is present, fall back to any other printed order/reference number on the slip — including a QFC-style code of the form `QFC-<store>-<YYYY-MM-DD>` (e.g., "QFC-MI-2026-07-10"). Capture it verbatim. Do NOT leave this field blank whenever any order- or reference-number is printed anywhere on the slip.
