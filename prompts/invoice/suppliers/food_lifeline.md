...
- donor_org: These manifests carry a printed **donor/source code** (e.g., "SWY-GEN", "QFC-MI") identifying the donating retailer/program. Capture it verbatim into `donor_org`. Only set `donor_org = null` if no such donor code is printed on the slip.
