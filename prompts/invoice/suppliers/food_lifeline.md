...
- donor_org: capture the donor source/retailer code printed on the manifest (e.g., "SWY-GEN" for Safeway General, "QFC-MI" for QFC). This is a short hyphenated code identifying the donating retailer/program, usually near the item source or donor field. Copy it verbatim. Only set donor_org = null if no such donor code appears on the document.
