...
- invoice_or_order_number: Use the **Agency Order No** value in the upper-right (e.g., "ACR-XXXXXX"). If no "Agency Order No" is printed, fall back to any other order/store reference number on the slip and capture it verbatim — e.g., a grocery store order code like "QFC-MI-2026-07-10". Never leave this field blank when any such reference number is visible.
