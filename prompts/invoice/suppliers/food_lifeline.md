...
- invoice_or_order_number: Use the **Agency Order No** value in the upper-right (e.g., "ACR-XXXXXX"). If there is no Agency Order No box (or it is blank), fall back to any printed store/donor reference code of the form `<STORE>-<DEPT>-<DATE>` (e.g., "QFC-MI-2026-07-10") and use that verbatim. Never leave this field blank when such a reference is present on the slip.
