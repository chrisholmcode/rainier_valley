...
- donor_org: Capture the printed **Donor** code verbatim (e.g., "SWY-GEN", "QFC-MI"). These are grocery-source codes identifying the retailer/program that donated the goods. If no donor code is printed anywhere on the manifest, set donor_org = null.
