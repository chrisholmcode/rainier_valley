...
- donor_org: Capture the printed retail donor code verbatim, including its suffix (e.g., "SWY-GEN" = Safeway General, "QFC-MI" = QFC). Only set `donor_org = null` when the manifest shows no donor code at all. Do NOT default this field to null.
