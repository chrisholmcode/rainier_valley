...
- donor_org: capture the donor/source code printed on the manifest verbatim (short uppercase org code, e.g., "SWY-GEN" for Safeway General, "QFC-MI"). It typically appears near the donor/source line or item source. Only set donor_org = null when no such code appears anywhere on the document.
