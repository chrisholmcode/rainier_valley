...
- invoice_or_order_number: Use the **Agency Order No** value in the upper-right (e.g., "ACR-XXXXXX"). If no "ACR-…" value is present, capture whatever order/invoice identifier is printed on the slip verbatim, including store- or program-prefixed codes such as "QFC-MI-2026-07-10". Never leave this field blank when any such identifier is visible.
