...
- document_type = "manifest". supplier = "food_lifeline". donor_org = extracted from the printed donor/source code on the manifest (see donor_org rule below). is_donation = true.
