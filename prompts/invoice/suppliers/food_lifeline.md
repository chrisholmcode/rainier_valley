...
- donor_org: capture the printed donor source code from the manifest verbatim (e.g., a retail-donor code like `SWY-GEN` or `QFC-MI`). Use null ONLY if no donor code appears anywhere on the document.
