...
- invoice_or_order_number: Use the **Agency Order No** value in the upper-right (e.g., "ACR-XXXXXX"). If no "ACR-…" Agency Order No is printed, fall back to the store/reference order code on the slip — e.g., a QFC-MI style code like "QFC-MI-2026-07-10" — and capture it verbatim. Never leave this field blank when any order or reference number is visible.
