...
- Qty may be a non-integer (e.g., 1480.5) — preserve as-is. The Qty represents the total billed unit (often pounds for ground beef, packages for portioned meat); do NOT recompute from the pack notation in the description.
...
- delivery_date: Use the **Ship date** field in the "Shipping info" block (NOT "Invoice date" or "Due date"). Convert MM/DD/YYYY to YYYY-MM-DD.
