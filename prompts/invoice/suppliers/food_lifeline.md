...
- invoice_or_order_number: Use the **Agency Order No** value in the upper-right (e.g., "ACR-XXXXXX"). If no "ACR-" Agency Order No is present, capture the store/order identifier printed elsewhere on the slip verbatim — these often follow a QFC store-code + date format (e.g., "QFC-MI-2026-07-10"). Do NOT leave this field blank whenever any order/invoice-style identifier appears anywhere on the document.
