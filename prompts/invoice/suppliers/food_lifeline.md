...
- donor_org: capture the donor/source code printed on the manifest verbatim (e.g., "SWY-GEN" for Safeway general, "QFC-MI"). These are typically a retailer abbreviation plus a program/region suffix. Only set donor_org = null if no such donor code appears on the document.
