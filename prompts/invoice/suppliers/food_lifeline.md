...
- invoice_or_order_number: Use the order/invoice reference on the manifest. This is usually the **Agency Order No** value in the upper-right (e.g., "ACR-XXXXXX"), but some manifests instead carry a donor/store-prefixed reference such as "QFC-MI-2026-07-10". Capture whichever identifier is present, verbatim. Do NOT leave this field blank if any order/invoice/reference number appears on the slip.
