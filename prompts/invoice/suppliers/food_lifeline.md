...
- invoice_or_order_number: Use the **Agency Order No** value in the upper-right (e.g., "ACR-XXXXXX"). If no "ACR-" Agency Order No is present, capture any other printed order/invoice identifier on the slip verbatim — e.g., a store-code style number like "QFC-MI-2026-07-10". Never leave this field blank when any such printed identifier is visible.
