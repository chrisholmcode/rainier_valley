...
- invoice_or_order_number: Use the **Agency Order No** value in the upper-right (e.g., "ACR-XXXXXX"). If no "ACR-" Agency Order No is printed, fall back to any other invoice/order reference on the slip — including store- or vendor-style codes such as "QFC-MI-2026-07-10" (source prefix + date). Capture it verbatim. Never leave this field blank when any order or invoice number appears anywhere on the document.
