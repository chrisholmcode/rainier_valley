...
- document_type = "manifest". supplier = "food_lifeline". is_donation = true. donor_org = the printed donor source code (see donor_org rule below); null only if none is printed.
