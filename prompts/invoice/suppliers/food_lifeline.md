...
- donor_org = the donor/source code printed on the manifest (e.g., "SWY-GEN" for Safeway General, "QFC-MI" for QFC), captured verbatim. These short hyphenated codes identify the donating retailer/source. Only set donor_org = null if no such donor code appears on the document.
