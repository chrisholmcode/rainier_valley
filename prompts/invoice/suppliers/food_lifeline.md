...
- invoice_or_order_number: Use the **Agency Order No** value in the upper-right (e.g., "ACR-XXXXXX"). If no "Agency Order No" field is present, fall back to any other printed invoice/order/reference number on the slip — including store- or donor-prefixed IDs such as "QFC-MI-2026-07-10" — capturing it verbatim. Never leave this field blank when any such number is visible.
