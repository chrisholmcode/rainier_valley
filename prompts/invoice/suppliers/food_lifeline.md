...
- invoice_or_order_number: Use the **Agency Order No** value in the upper-right (e.g., "ACR-XXXXXX"). If no "ACR-" value is present, use whatever printed order / invoice / PO number the manifest carries — including QFC-style codes like "QFC-MI-2026-07-10" — and capture it verbatim. Never leave this field blank when any such identifier is printed on the slip.
