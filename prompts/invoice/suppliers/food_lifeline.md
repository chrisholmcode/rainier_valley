...
- document_type = "manifest". supplier = "food_lifeline". is_donation = true. donor_org: capture the printed donor source code verbatim (e.g., "SWY-GEN", "QFC-MI") — this identifies the originating retail donor/program. Only set donor_org = null if no such code appears anywhere on the manifest.
