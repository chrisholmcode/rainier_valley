...
- invoice_or_order_number: Use the **Agency Order No** value in the upper-right (e.g., "ACR-XXXXXX"). If there is no "Agency Order No" box, capture any other printed order/reference code on the slip verbatim instead of leaving this blank — including a store-code + date form like "QFC-MI-2026-07-10". Never leave invoice_or_order_number blank when any such reference number is legible on the document.
