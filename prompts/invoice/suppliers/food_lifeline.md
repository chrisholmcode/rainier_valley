...
- invoice_or_order_number: Use the **Agency Order No** value in the upper-right (e.g., "ACR-XXXXXX"). If no field labeled "Agency Order No" is present, fall back to any other printed order/reference/store code on the slip — including store-prefixed codes such as `QFC-MI-2026-07-10` (grocery-partner code: `<STORE>-<REGION>-<DATE>`). Capture it verbatim. Do NOT leave this field blank when any such identifier is visible.
