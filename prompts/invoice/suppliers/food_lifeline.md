...
- donor_org = the donor source code printed on the slip (e.g., "SWY-GEN", "QFC-MI") — capture it verbatim, including the trailing sub-code after the dash. Only set donor_org = null if no donor code appears on the document.
