...
- invoice_or_order_number: Use the **Agency Order No** value in the upper-right (e.g., "ACR-XXXXXX"). If there is no "Agency Order No" field, capture any other printed order/invoice/reference number verbatim — including store- or donor-supplied codes that combine a store prefix with a date, e.g. "QFC-MI-2026-07-10". Do NOT leave this field blank whenever any such identifier is visible on the slip.
