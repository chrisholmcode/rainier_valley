...
- invoice_or_order_number: Prefer the **Agency Order No** value in the upper-right (e.g., "ACR-XXXXXX"). If that field is absent or blank, capture any other printed order / reference / PO number on the slip verbatim (e.g., a store or reference code like "QFC-MI-2026-07-10"). Do NOT leave this blank when any order/reference number is visible; only leave it null if none appears anywhere on the document.
